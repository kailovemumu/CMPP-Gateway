 ...
 * @version $Id$
 */
public class SmsTextMessage<main> extends SmsConcatMessage implements Serializable
{
    /**
	 * 
	 */
    ...
    public static void main(String[] args) {
        String content = "今天，外交部发言人今天，外交部发言人华春莹回应美今天，外交部发言人华春莹回应美今天，外交部发言人华春莹回应美今天，外交部发言人华春莹回应美今天，外交部发言人华春莹回应美今天，外交部发言人华春莹回应美今天，外交部发言人华春莹回应美今天，外交部发言人华春莹回应美华春莹回应美";
        long current = System.currentTimeMillis();
        for(int i = 0; i < 100000; i++) {
            int len = new SmsTextMessage(content+i).getPdus().length;
        }
